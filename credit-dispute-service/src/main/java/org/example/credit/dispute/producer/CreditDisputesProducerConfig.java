...
public class CreditDisputesProducerConfig {

	private static final Logger LOGGER = Logger.getLogger(CreditDisputesProducerConfig.class.getName());
	...
	public CreditDisputesProducerConfig(String bootstrapServers, String topic, String securityProtocol,
	...
	public static CreditDisputesProducerConfig fromEnv() {
		...
		return new CreditDisputesProducerConfig(bootstrapServers, topic, securityProtocol, serializerClass, acks);
	}

	public static Properties createProperties(CreditDisputesProducerConfig config) {
